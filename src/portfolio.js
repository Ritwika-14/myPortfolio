...
const experience = {
  ...
  description:
    "I BELONG TO MY SOPHOMORE YEAR EXPLORING INTERSHIPS AND SEEKING FOR BETTER.",
...
const contactPageData = {
  contactSection: {
    ...
    description:
      "I am available on almost every social media. You can message me, I will reply within 24 hours. I can help you with Front-end development, Competitive Programming & Opensource Development(Beginner).",
  },
  blogSection: {
    title: "Blogs",
    subtitle:
      "Sometimes i engage in writing.",
    link: "https://connectmindtoheart.blogspot.com/",
